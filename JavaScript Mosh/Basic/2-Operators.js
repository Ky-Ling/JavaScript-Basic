 ...
 * @LastEditors: GC
 * @LastEditTime: 2022-02-05 21:34:44
 * @FilePath: \JavaScript Mosh\Basic\2-Operators.js
 */
...
console.log(1 == 1);
console.log("1" == 1); // True --> Because the left side is a string, so it will revert "1" of the right side
//                          to a string ('1' == '1')
